module github.com/byteorbit/terragrunt-atlantis-config
...
require (
	...
	github.com/gruntwork-io/terragrunt v0.91.2
...
require (
	...
	github.com/gruntwork-io/terragrunt-engine-go v0.0.16 // indirect
