...
build {
  ...
  provisioner "shell" {
    inline = [
      "wget https://github.com/byteorbit/terragrunt-atlantis-config/releases/download/v${var.terragrunt_atlantis_config_version}/terragrunt-atlantis-config_${var.terragrunt_atlantis_config_version}_linux_amd64.tar.gz",
...
| `extra_atlantis_dependencies` | See [Extra dependencies](https://github.com/byteorbit/terragrunt-atlantis-config#extra-dependencies)                                                        | list(string) |
...
```bash
go install github.com/byteorbit/terragrunt-atlantis-config@v1.23.2-BO
```
